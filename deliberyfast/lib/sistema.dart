...
class Sistema {
  ...
  static const String DOMINIO_GLOBAL = 'http://178.128.154.44/';
  ...
  static const String MESAJE_SHARE_LINK =
      'Descarga gratis Delibery Fast y encuentra promociones exclusivas.';
  ...
  static const sloganCuriosity =
      'Delibery Fats, para las personas que quieren más.';
  static const aplicativoCuriosity = 'Delibery Fast';
  static const idAplicativoCuriosity = 1000001;
  static const aplicativoTitleCuriosity = 'Delibery Fast';
  static const packageNameCuriosity = 'com.rover.curiosity';
  static const appStoreIdCuriosity = '1488624281';
  static const uriDynamicCuriosity =
      'https://deliveryfast.hy-alliance.com/index.html';
  ...
  static get uriPrefix =>
      'https://dln.hy-alliance.com'; //La barra al final causa problemas en iOS
