    ...
    if (chatCompraModel.tipo == conf.CHAT_TIPO_CONFIRMACION) {
      ...
      return Column(
        ...
        children: <Widget>[
          ...
          Divider(),
          Text(
              'Costo ${(double.parse(chatCompraModel.valor)).toStringAsFixed(2)} RD incluye envío',
              style: TextStyle(color: Colors.black),
              textAlign: TextAlign.left),
        ],
      );
    ...
    if (chatCompraModel.tipo == conf.CHAT_TIPO_PRESUPUESTO)
      return Column(
        ...
        children: <Widget>[
          ...
          Divider(),
          Text(
              'Costo: ${double.parse(chatCompraModel.valor.toString()).toStringAsFixed(2)} RD',
    ...
    if (chatCompraModel.tipo == conf.CHAT_TIPO_CONFIRMACION) {
      ...
      return Column(
        ...
        children: <Widget>[
          ...
          Divider(),
          Text(
              'Costo ${(double.parse(chatCompraModel.valor)).toStringAsFixed(2)} ED incluye envío',
              style: TextStyle(color: Colors.white, fontSize: 20.0),
              textAlign: TextAlign.right),
        ],
      );
